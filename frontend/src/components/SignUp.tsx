    ...
    return (
        ...
        flex flex-col items-center justify-center'>
            <div className="mb-6 text-center">
                <div className="w-16 h-16 bg-gradient-to-br from-red-500 to-red-800 rounded-full
            ...
            <form onSubmit={handleSubmit} className='space-y-4'>
                {FIELDS.map(({ name, type, placeholder, icon: Icon }) => (
                    <div key={name} className='flex items-center border border-red-100 rounded-lg px-3 
                ...
                <button type='submit' className='w-full bg-gradient-to-r from-red-500 to-red-900 text-white 
                text-sm font-semibold py-2.5 rounded-lg hover:shadow-md transition-all duration-200 flex items-center
                justify-center gap-2 cursor-pointer' disabled={loading}>
