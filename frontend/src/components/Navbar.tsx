...
const Navbar = ({ user = {}, onLogout }) => {
    ...
    return (
        <header className="sticky top-0 z-50 bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-200 font-sans">
            <div className="flex items-center justify-between px4 py-3 md:px-6 max-w-7xl mx-auto">
                {/* Logo */}
                <div className="flex items-center gap-2 cursor-pointer group" onClick={() => navigate("/")}>
                    ...
                    {/* NAME */}
                    <span
                        className="text-2xl font-extrabold bg-gradient-to-r from-red-500 
                        ...
                        {menuOpen && (
                            ...
                            shadow-xl border border-purple-100 z-50 overflow-hidden animate-fadeIn">
                                ...
                                <li className="p-2">
                                    ...
                                    items-center gap-2 rounded-lg px-3 py-2 text-sm hover:bg-red-50 text-red-600">
